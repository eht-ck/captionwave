...
export default function ResultVideo({filename,transcriptionItems}) {
  const videoUrl = "https://chandresh-transcribe.s3.amazonaws.com/"+filename;
  ...
  <>
    <div className="mb-4 flex justify-center space-x-4">
      <button
        onClick={transcode}
        className="bg-green-600 py-2 px-6 rounded-full flex items-center gap-2 border-2 border-purple-700/50 cursor-pointer"
      >
        <SparklesIcon />
      ...
      <button
        onClick={downloadSRT}
        className="bg-blue-500 py-2 px-6 rounded-full flex items-center gap-2 border-2 border-blue-700/50 cursor-pointer"
      >
        <SparklesIcon />
    ...
    <div className="flex flex-col items-center mb-4">
      <label className="mb-2 text-lg font-semibold">Primary Color:</label>
      <input
        type="color"
        value={primaryColor}
      ...
      />
      <label className="mt-2 mb-2 text-lg font-semibold">Outline Color:</label>
      <input
        type="color"
        value={outlineColor}
